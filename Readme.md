Problems: 
- Binding(install). Solution - zenject, or expand the current solution with locators.
- Items and currencies. Solution - separate data and logic, operate only with controllers, example: _inventory.Add(_factor.CreateController(someConfigData), count).
